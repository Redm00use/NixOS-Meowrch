...
# Check for NixOS 25.11 compatibility
if grep -q "25.11" flake.nix; then
    print_success "NixOS 25.11 version specified"
else
...
print_status "Checking for modern NixOS 25.11 service options..."

...
### 🎮 GPU профили в установщике

Установщик теперь поддерживает такие профили:
...
Для гибридных ноутбуков с `Nvidia PRIME` выполните:
...
После этого проверьте значения в `modules/nixos/system/graphics-nvidia-prime.nix:1` перед применением.
